            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    <?php
                        ...
                        $q2="SELECT * FROM category where category_id = {$cid}";
                        $r2=mysqli_query($con,$q2) or die("Query Failed");
                        $r3=mysqli_fetch_assoc($r2);
                    ?>        
                    
                    <h2 class="page-heading"><?php echo $r3['category_name']; ?> </h2>
                    <!-- <h2 class="page-heading"><?php //echo $r3['category_name']. " News"; ?> </h2> -->
